...
public class WaterPipeLayerController {
    ...
    public ResponseEntity updateWaterPipeLayer(@RequestBody WaterPipeLayer waterPipeLayer) {
        return ResponseEntity.ok(waterPipeService.updateWaterPipeLayer(waterPipeLayer));
    }
