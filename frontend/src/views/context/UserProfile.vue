              ...
              <el-col :xs="4" :sm="6" :md="8" :lg="9">
                <div class="bg-purple-light item-content">
                  <div class="input-message">
                    ...
                    <span v-show="errors.has('email') && isShow" class="help is-danger" style="color: #ed5565" >请输入电子邮箱</span>
                  </div>
                </div>
              </el-col>
            </el-row>
              ...
              <el-col :xs="4" :sm="6" :md="8" :lg="9">
                <div class="bg-purple-light item-content">
                  <div class="input-message">
                    ...
                    <span v-show="errors.has('phone') && isShow" class="help is-danger" style="color: #ed5565">请输入手机号</span>
                  </div>
                </div>
              </el-col>
            </el-row>
